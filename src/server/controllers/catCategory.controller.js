...
exports.create = ( req, res ) => {
  var body = _.pick( req.body, [ 'order', 'name', 'description' ])
  if ( !body.name ) {
  ...
  newCatCategory.save()
    ...
    .catch(( e ) => 
      res.status( 400 ).send( apiErrorMsg( 'create', 'category', e )))
}
...
exports.list = ( req, res ) => {
  CatalogCategory.find()
    ...
    .catch(( e ) => 
      res.status( 400 ).send( apiErrorMsg( 'get', 'categories', e )))
}
...
exports.deleteAll = ( req, res ) => {
  CatalogCategory.remove({})
    ...
    .catch(( e ) => 
      res.status( 400 ).send( apiErrorMsg( 'delete', 'categories', e )))
}
...
exports.findById = ( req, res ) => {
  ...
  CatalogCategory.findById( id )
    ...
    .catch(( e ) => 
      res.status( 400 ).send( apiErrorMsg( 'get', 'category by ID', e )))
}
