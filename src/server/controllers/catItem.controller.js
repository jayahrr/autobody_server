...
exports.create = ( req, res ) => {
  let body = _.pick( req.body, [ 'order', 'name', 'description', 'category', 'price', 'estimated_duration' ])
  if ( !body.name ) {
  ...
  newCatItem.save()
    ...
    .catch(( e ) => 
      res.status( 400 ).send( apiErrorMsg( 'create', 'catalog item', e )))
}
...
exports.list = ( req, res ) => {
  CatalogItem.find()
    ...
    .catch(( e ) => 
      res.status( 400 ).send( apiErrorMsg( 'get', 'catalog items', e )))
}
...
exports.deleteAll = ( req, res ) => {
  CatalogItem.remove({})
    ...
    .catch(( e ) => 
      res.status( 400 ).send( apiErrorMsg( 'delete', 'catalog items', e )))
}
